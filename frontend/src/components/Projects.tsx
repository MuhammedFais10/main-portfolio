...
import { Projector, Github, ArrowRight, ExternalLink, Star, Users, Calendar } from 'lucide-react';
...
const Projects = () => {
  ...
  />
        ...
        <div className="mt-16 text-center">
          <button className="border-2 border-primary/20 text-primary px-8 py-4 rounded-xl font-semibold hover:border-primary/40 hover:bg-primary/5 transition-all duration-300 hover:scale-105">
            View All Projects
          </button>
        </div>
      </div>
